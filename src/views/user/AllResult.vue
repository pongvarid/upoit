                  ...
                  <v-expansion-panel-content>
                    ...
                    <div class="flex flex-col md:flex-row">
                      ...
                      <div class="w-full md:w-1/3">
                        <h2 class="p-2 text-xl font-bold text-purple-800">การให้คะแนน <h2 class="p-4 text-xl font-bold text-purple-600">ผลตรวจ {{oit.evaluate.score}} คะแนน</h2></h2>
                          <v-select disabled required v-model="oit.evaluate.rate_status" label="สถานะการตรวจสอบ" placeholder="ระบุสถานะ"
                                     :items="rateStatus" item-text="name" item-value="id" filled></v-select>

                          <v-textarea disabled  v-model="oit.evaluate.comment" label="ความคิดเห็น" placeholder="ข้อความ" outlined></v-textarea>
