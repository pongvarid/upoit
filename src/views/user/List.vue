        ...
        <div class="relative w-full mt-4 mb-4 max-w-full flex-grow flex-1 px-2 py-2" v-if="response">
          <div class="flex flex-wrap">
            <div class="w-full md:w-4/12 p-2" v-for="year,i in years" :key="i">
              <div @click="$router.push(`/user/all/result?year=${year.id}&id=${$route.query.id}`)" class="flex cursor-pointer	 items-center p-4  bg-white rounded-lg shadow-xl dark:bg-gray-800 border-b-4  elevation-6" style="border-color:#FFC300;">
