  ...
  <div  >
    <div class="block relative " style="z-index:1;" >
      <div class="container px-4 py-4 mx-auto">
        <h2 class="text-xl mt-2 leading-tight font-semibold font-heading"> สำหรับกรอกข้อมูลผู้มีส่วนได้ส่วนเสียภายนอก</h2>
        ...
        <table>
          ...
          <tr  >
            <td><v-text-field filled dense label="ชื่อองค์กร/ชื่อ - นามสกุล	" v-model="form.name"></v-text-field></td>
            <td><v-text-field filled dense label="เบอร์โทรศัพท์" v-model="form.tel"></v-text-field></td>
            <td><v-text-field filled dense label="อีเมล์" v-model="form.email"></v-text-field></td>
            <td><v-text-field filled dense label="การติดต่อ" v-model="form.other"></v-text-field></td>
            <td><v-text-field filled dense label="ประเภทการติดต่อ" v-model="form.type"></v-text-field></td>
            <td><v-btn color="primary" @click="addEit()">เพิ่ม</v-btn></td>
          </tr>
          <tr v-for="item,index in lists" :key="index">
            <td><v-text-field filled dense label="ชื่อองค์กร/ชื่อ - นามสกุล	" v-model="item.name"></v-text-field></td>
            <td><v-text-field filled dense label="เบอร์โทรศัพท์" v-model="item.tel"></v-text-field></td>
            <td><v-text-field filled dense label="อีเมล์" v-model="item.email"></v-text-field></td>
            <td><v-text-field filled dense label="การติดต่อ" v-model="item.other"></v-text-field></td>
            <td><v-text-field filled dense label="ประเภทการติดต่อ" v-model="item.type"></v-text-field></td>
            <td >
